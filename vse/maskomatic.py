...
class SEQUENCER_PT_maskomatic(bpy.types.Panel):
    bl_label = "Maskomatic"
    bl_idname = "strip.SEQUENCER_PT_maskomatic"
...
class SEQUENCER_OT_maskomatic(bpy.types.Operator):
    bl_idname = "strip.SEQUENCER_OT_maskomatic"
...
classes = (
    SEQUENCER_PT_maskomatic,
    #SEQUENCER_OT_maskomatic,
    )
